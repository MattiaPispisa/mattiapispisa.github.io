...
const posts: (t: LanguageResolver) => PostModel[] = (t) => [
    ...
    },
    {
        ...
        description: <DevToArticleDetail id={1694811} description={t("flutterWebNotReady")}/>,
        date: "2023-12-12",
    ...
    },
    {
        ...
        description: <DevToArticleDetail id={1647545} description={t("reactHooksDeppDiving")}/>,
        date: "2023-10-28",
    ...
    },
    {
        ...
        description: <DevToArticleDetail id={1573381} description={t("flutterAndMonorepo")}/>,
        date: "2023-10-10",
    ...
    },
    {
        ...
        description: <DevToArticleDetail id={1563960} description={t("flutterDI")}/>,
        date: "2023-08-10",
        hashtags: ["flutter", "dart", "dependency_injection"],
    },
];
